...
namespace QUT.Gplex.Parser
{
	...
	internal sealed class AAST
	{
        ...
        private void InitCharCats()
        {
            ...
            cats.Add("IsUcClosePunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.ClosePunctuation)));
            cats.Add("IsUcConnectorPunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.ConnectorPunctuation)));
            cats.Add("IsUcControl", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.Control)));
            cats.Add("IsUcCurrencySymbol", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.CurrencySymbol)));
            cats.Add("IsUcDashPunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.DashPunctuation)));
            cats.Add("IsUcDecimalDigitNumber", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.DecimalDigitNumber)));
            cats.Add("IsUcEnclosingMark", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.EnclosingMark)));
            cats.Add("IsUcFinalQuotePunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.FinalQuotePunctuation)));
            cats.Add("IsUcFormat", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.Format)));
            cats.Add("IsUcInitialQuotePunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.InitialQuotePunctuation)));
            cats.Add("IsUcLetterNumber", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.LetterNumber)));
            cats.Add("IsUcLineSeparator", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.LineSeparator)));
            cats.Add("IsUcLowercaseLetter", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.LowercaseLetter)));
            cats.Add("IsUcMathSymbol", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.MathSymbol)));
            cats.Add("IsUcModifierLetter", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.ModifierLetter)));
            cats.Add("IsUcModifierSymbol", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.ModifierSymbol)));
            cats.Add("IsUcNonSpacingMark", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.NonSpacingMark)));
            cats.Add("IsUcOpenPunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.OpenPunctuation)));
            cats.Add("IsUcOtherLetter", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.OtherLetter)));
            cats.Add("IsUcOtherNotAssigned", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.OtherNotAssigned)));
            cats.Add("IsUcOtherNumber", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.OtherNumber)));
            cats.Add("IsUcOtherPunctuation", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.OtherPunctuation)));
            cats.Add("IsUcOtherSymbol", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.OtherSymbol)));
            cats.Add("IsUcParagraphSeparator", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.ParagraphSeparator)));
            cats.Add("IsUcPrivateUse", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.PrivateUse)));
            cats.Add("IsUcSpaceSeparator", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.SpaceSeparator)));
            cats.Add("IsUcSpacingCombiningMark", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.SpacingCombiningMark)));
            cats.Add("IsUcSurrogate", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.Surrogate)));
            cats.Add("IsUcTitlecaseLetter", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.TitlecaseLetter)));
            cats.Add("IsUcUppercaseLetter", new PredicateLeaf(PredicateLeaf.MkUnicodeCategoryTest(UnicodeCategory.UppercaseLetter)));
    ...
    internal sealed class PredicateLeaf : Leaf
    {
        ...
        internal static CharTest MkUnicodeCategoryTest(UnicodeCategory category)
        {
            return delegate(int ord)
            {
                UnicodeCategory actualCategory;
                if (ord <= (int)Char.MaxValue)
                    actualCategory = char.GetUnicodeCategory((char)ord);
                else
                    actualCategory = char.GetUnicodeCategory(Char.ConvertFromUtf32(ord), 0);
